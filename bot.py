...
class RatsKingdom:
    def __init__(self) -> None:
        ...
        self.headers = {
            ...
            'Pragma': 'no-cache',
            'Referer': 'https://d1tt9nsj36gcwe.cloudfront.net/?tgWebAppStartParam=1719410244',
    ...
    def welcome(self):
        ...
        {Fore.GREEN + Style.BRIGHT}Auto Claim {Fore.BLUE + Style.BRIGHT}Rats Kingdom - BOT
            """
            f"""
        {Fore.GREEN + Style.BRIGHT}Rey? {Fore.YELLOW + Style.BRIGHT}The Shadowscripter (https://t.me/shadowscripters)
            """
        )
